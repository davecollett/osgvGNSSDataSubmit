...
def get_smes (nine_fig):
	...
	get_smes.datumPublishedDate = json.loads(s.decode())["data"]["datumPublishedDate"]
	get_smes.datumTechnique = json.loads(s.decode())["data"]["datumTechnique"]
	get_smes.datumMeasurements = json.loads(s.decode())["data"]["datumMeasurements"]
	get_smes.datumSource = json.loads(s.decode())["data"]["datumSource"]
